...
import img from "../../assets/IMG/register-page-img.png";
import "./RegisterVen.css";

const RegisterVendor = ({ onSwitch }) => {
    ...
    <div className="container">
      <div className="container">
        <div className="register-card">
          <button className="back-button" onClick={() => onSwitch("login")}>Back</button>
          <div className="register-content">
            <div className="col-md-5 register-image-section">
              <div className="background-image-wrapper d-none d-md-block">
                <img
                  src={img}
                  alt="Illustration"
                  className="register-illustration w-100 ms-5"
                />
              </div>
            </div>
            ...
            <div className="col-md-7 register-form-section">
              ...
              <p>Enter your information to request a new account</p>
              ...
              <div className="d-flex align-items-center justify-content-center mb-3 justify-content-md-end mb-md-0">
                <button className="create-account text-uppercase input-bottom-shadow">
                  Submit request
                </button>
              </div>
            </div>
